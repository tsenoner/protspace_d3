        ...
        <div class="modal-content" @click=${(e: Event) => e.stopPropagation()}>
          ...
          <div class="other-items-list" style="display:flex;flex-direction:column;gap:10px;">
            ...
            <div style="margin-top:12px;">
              ...
              <div
                style="display:flex;flex-direction:column;gap:6px;max-height:200px;overflow:auto;"
              >
                ${featureNames.map(
                  (fname) => html`
                    <div
                      style="display:flex;align-items:center;justify-content:space-between;gap:10px;border:1px solid #eee;border-radius:6px;padding:6px 8px;"
                    >
