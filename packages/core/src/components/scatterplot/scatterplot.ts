...
export class ProtspaceScatterplot extends LitElement {
  static styles = css`
    :host {
      ...
      --protspace-point-opacity-selected: 1.0;
  ...
  private _createResetButton() {
    ...
    const resetButton = this._svgSelection
      ...
      .attr('transform', `translate(${config.width - config.margin.right - 60}, ${config.margin.top + 10})`)
      .attr('cursor', 'pointer')
    ...
    resetButton
      ...
      .append('path')
      .attr('d', 'm3.98652376 1.07807068c-2.38377179 1.38514556-3.98652376 3.96636605-3.98652376 6.92192932 0 4.418278 3.581722 8 8 8s8-3.581722 8-8-3.581722-8-8-8')
  ...
  render() {
    ...
    return html`
      <div class="container">
        ...
        ${this._isLoading || this._isTransitioning ? html`
        ...
        ${this.selectionMode ? html`
          <div class="mode-indicator">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor">
              <rect x="3" y="3" width="18" height="18" rx="1" stroke-dasharray="2 1"/>
        ...
        ${this.isolationMode && this.splitHistory ? html`
        ...
        ${this._tooltipData ? html`
          ...
          ">
            ...
            <div class="tooltip-feature">
              ${this.selectedFeature}: ${this._tooltipData.protein.featureValues[this.selectedFeature] || 'N/A'}
            </div>
