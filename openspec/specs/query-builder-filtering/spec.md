# query-builder-filtering Specification

## Purpose

The filter query builder: opening it from the control bar, building a condition against one annotation with a type-appropriate input, and what applying, resetting or loading a new dataset does to the active filter.
