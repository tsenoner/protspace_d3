# protein-search-feedback Specification

## Purpose

What the protein search tells a user about their query and their current selection: which
proteins the suggestion list shows, how already-selected ones are marked and removed again,
what the no-match message is allowed to claim, and how both the list and the keyboard cursor
are conveyed to assistive technology.
