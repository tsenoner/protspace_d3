# eat-provenance-connectors Specification

## Purpose

The on-plot connector lines that show where a transferred annotation came from, linking a predicted protein to the reference it was copied from. Covers fan-out bounds, behaviour under zoom and pan, dismissability, and not relying on colour alone to carry meaning.
