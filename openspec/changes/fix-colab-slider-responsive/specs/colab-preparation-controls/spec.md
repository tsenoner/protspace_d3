...
- **WHEN** three parameter groups are visible and the notebook content area becomes too narrow to allocate at least 300 px plus configured gaps to each group
...
- **WHEN** the notebook content area can allocate at least 300 px plus configured gaps to each of three visible groups
